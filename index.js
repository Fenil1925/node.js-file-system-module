...
/* built-in process object and readline module */
...
var createDirWizard = () => 
{
    rl.question("Enter name of the directory: ", (ans) => 
    {
        ...
        {
            console.log("Soory This directory already exist");
        }
        repeat();
    });
};
...
var removeDirWizard = () => 
{
    rl.question("Enter name of the directory: ", (ans) => 
    {
        ...
        {
            console.log("Soory This directory not exist");
        }
        repeat();
    });
};
...
var start = () => 
{
    rl.question("Enter your choice : ", (answer) => 
    {
        ...
        {
            console.log("Sorry, Wrong input. Please Enter valid choice");
            repeat();
        }
    });
};

/* Create function for repeat instructions and choising for users */
var repeat = () => 
{
    instruction();
    start();
